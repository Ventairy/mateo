...
class _BankBuildingPainter extends CustomPainter {
  _BankBuildingPainter({required this.color1});
...
class _BeerMug extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _BeerMugPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _BeerMugPainter extends CustomPainter {
  _BeerMugPainter({required this.color1});
...
class _Bicycle extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _BicyclePainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _BicyclePainter extends CustomPainter {
  _BicyclePainter({required this.color1});
...
class _Book extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _BookPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _BookPainter extends CustomPainter {
  _BookPainter({required this.color1});
...
class _BoxPencil extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _BoxPencilPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _BoxPencilPainter extends CustomPainter {
  _BoxPencilPainter({required this.color1});
...
class _Broom extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _BroomPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _BroomPainter extends CustomPainter {
  _BroomPainter({required this.color1});
...
class _Buildings extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _BuildingsPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _BuildingsPainter extends CustomPainter {
  _BuildingsPainter({required this.color1});
...
class _BusFront extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _BusFrontPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _BusFrontPainter extends CustomPainter {
  _BusFrontPainter({required this.color1});
...
class _CheckeredFlagPainter extends CustomPainter {
  _CheckeredFlagPainter({required this.color1});
...
class _Checkmark extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _CheckmarkPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _CheckmarkPainter extends CustomPainter {
  _CheckmarkPainter({required this.color1});
...
class _ClassicBuildingPainter extends CustomPainter {
  _ClassicBuildingPainter({required this.color1});
...
class _DiscoBall extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _DiscoBallPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _DiscoBallPainter extends CustomPainter {
  _DiscoBallPainter({required this.color1});
...
class _DoubleCrossPainter extends CustomPainter {
  _DoubleCrossPainter({required this.color1});
...
class _Drop extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _DropPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _DropPainter extends CustomPainter {
  _DropPainter({required this.color1});
...
class _DropFoam extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _DropFoamPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _DropFoamPainter extends CustomPainter {
  _DropFoamPainter({required this.color1});
...
class _Dumbbell extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _DumbbellPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _DumbbellPainter extends CustomPainter {
  _DumbbellPainter({required this.color1});
...
class _Eraser extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _EraserPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _EraserPainter extends CustomPainter {
  _EraserPainter({required this.color1});
...
class _EvPlug extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _EvPlugPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _EvPlugPainter extends CustomPainter {
  _EvPlugPainter({required this.color1});
...
class _FerrisWheelPainter extends CustomPainter {
  _FerrisWheelPainter({required this.color1});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(__path5, _fillPaint..color = color1);
    canvas.drawPath(__path6, _fillPaint..color = color1);
    canvas.drawPath(__path7, _fillPaint..color = color1);
    canvas.restore();
  }
...
class _Flame extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _FlamePainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _FlamePainter extends CustomPainter {
  _FlamePainter({required this.color1});
...
class _ForkKnife extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _ForkKnifePainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _ForkKnifePainter extends CustomPainter {
  _ForkKnifePainter({required this.color1});
...
class _GasStationPainter extends CustomPainter {
  _GasStationPainter({required this.color1});
...
class _Gear extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _GearPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _GearPainter extends CustomPainter {
  _GearPainter({required this.color1});
...
class _Gift extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _GiftPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _GiftPainter extends CustomPainter {
  _GiftPainter({required this.color1});
...
class _GovernmentBuildingPainter extends CustomPainter {
  _GovernmentBuildingPainter({required this.color1});
...
class _GraduateCapPainter extends CustomPainter {
  _GraduateCapPainter({required this.color1});
...
class _HelicopterFrontPainter extends CustomPainter {
  _HelicopterFrontPainter({required this.color1});
...
class _Hookah extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _HookahPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _HookahPainter extends CustomPainter {
  _HookahPainter({required this.color1});
...
class _HotCoffeeCupPainter extends CustomPainter {
  _HotCoffeeCupPainter({required this.color1});
...
class _Info extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _InfoPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _InfoPainter extends CustomPainter {
  _InfoPainter({required this.color1});
...
class _LightningBoltPainter extends CustomPainter {
  _LightningBoltPainter({required this.color1});
...
class _MagnifyingGlassSadFacePainter extends CustomPainter {
  _MagnifyingGlassSadFacePainter({required this.color1});
...
class _MatiniGlassPainter extends CustomPainter {
  _MatiniGlassPainter({required this.color1});
...
class _MedicalCrossPainter extends CustomPainter {
  _MedicalCrossPainter({required this.color1});
...
class _PaperPlaneUpRightPainter extends CustomPainter {
  _PaperPlaneUpRightPainter({required this.color1});
...
class _ParkingSignPainter extends CustomPainter {
  _ParkingSignPainter({required this.color1});
...
class _Pencil extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _PencilPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _PencilPainter extends CustomPainter {
  _PencilPainter({required this.color1});
...
class _Pills extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _PillsPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _PillsPainter extends CustomPainter {
  _PillsPainter({required this.color1});
...
class _PlaneUpRightPainter extends CustomPainter {
  _PlaneUpRightPainter({required this.color1});
...
class _PoliceBadgePainter extends CustomPainter {
  _PoliceBadgePainter({required this.color1});
...
class _Popcorn extends StatelessWidget with _DotdartSvgSizing {
  ...
  /// Color 1 — defaults to 0xff060605.
  final Color? color1;
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _PopcornPainter(color1: color1 ?? const Color(0xff060605)),
          size: Size(width, height),
        ),
      ),
    );
...
class _PopcornPainter extends CustomPainter {
  _PopcornPainter({required this.color1});
...
class _PrayingFigurePainter extends CustomPainter {
  _PrayingFigurePainter({required this.color1});
...
class _RunningFigurePainter extends CustomPainter {
  _RunningFigurePainter({required this.color1});
...
class _SadEmoticonPainter extends CustomPainter {
  _SadEmoticonPainter({required this.color1});
...
class _SadMaskHappyMaskPainter extends CustomPainter {
  _SadMaskHappyMaskPainter({required this.color1});
...
class _Scissors extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _ScissorsPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _ScissorsPainter extends CustomPainter {
  _ScissorsPainter({required this.color1});
...
class _ShoppingBagPainter extends CustomPainter {
  _ShoppingBagPainter({required this.color1});
...
class _ShoppingCart extends StatelessWidget with _DotdartSvgSizing {
  ...
  /// Color 1 — defaults to 0xff0d0c0c.
  final Color? color1;

  /// Color 2 — defaults to 0xff000000.
  final Color? color2;
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _ShoppingCartPainter(
            color1: color1 ?? const Color(0xff0d0c0c),
            color2: color2 ?? const Color(0xff000000),
          ),
          size: Size(width, height),
        ),
      ),
...
class _ShoppingCartPainter extends CustomPainter {
  _ShoppingCartPainter({required this.color1, required this.color2});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(__path0, _fillPaint..color = color1);
    canvas.drawPath(__path1, _fillPaint..color = color1);
    canvas.drawPath(__path2, _fillPaint..color = color2);
    canvas.restore();
    canvas.restore();
  }
...
class _SleepingFigurePainter extends CustomPainter {
  _SleepingFigurePainter({required this.color1});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(__path0, _fillPaint..color = color1);
    canvas.drawOval(_ellipseRect0, _fillPaint..color = color1);
    canvas.restore();
  }
...
class _Stadium extends StatelessWidget with _DotdartSvgSizing {
  ...
  /// Color 1 — defaults to 0xff080706.
  final Color? color1;
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _StadiumPainter(
            color1: color1 ?? const Color(0xff080706),
            color2: color2 ?? const Color(0xff000000),
          ),
          size: Size(width, height),
        ),
...
class _StadiumPainter extends CustomPainter {
  _StadiumPainter({required this.color1, required this.color2});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(__path0, _fillPaint..color = color1);
    canvas.drawPath(__path1, _fillPaint..color = color2);
    canvas.drawPath(__path2, _fillPaint..color = color2);
    canvas.drawPath(__path3, _fillPaint..color = color2);
    canvas.restore();
  }
...
class _Star extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _StarPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _StarPainter extends CustomPainter {
  _StarPainter({required this.color1});
...
class _Tire extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _TirePainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _TirePainter extends CustomPainter {
  _TirePainter({required this.color1});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(__path6, _fillPaint..color = color1);
    canvas.drawPath(__path7, _fillPaint..color = color1);
    canvas.drawPath(__path8, _fillPaint..color = color1);
    canvas.drawPath(__path9, _fillPaint..color = color1);
    canvas.drawPath(__path10, _fillPaint..color = color1);
    canvas.restore();
    canvas.restore();
  }
...
class _TrainFrontPainter extends CustomPainter {
  _TrainFrontPainter({required this.color1});
...
class _Trash extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _TrashPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _TrashPainter extends CustomPainter {
  _TrashPainter({required this.color1});
...
class _Wifi extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _WifiPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _WifiPainter extends CustomPainter {
  _WifiPainter({required this.color1});
...
class _WineGlass extends StatelessWidget with _DotdartSvgSizing {
  ...
  Widget buildPainter({required double width, required double height}) {
    return SizedBox.fromSize(
      ...
      child: RepaintBoundary(
        child: CustomPaint(
          painter: _WineGlassPainter(color1: color1 ?? const Color(0xff000000)),
          size: Size(width, height),
        ),
      ),
    );
...
class _WineGlassPainter extends CustomPainter {
  _WineGlassPainter({required this.color1});
