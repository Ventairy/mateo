...
class _MateoActionMenuItem extends StatelessWidget {
  const _MateoActionMenuItem({
    required this.item,
            ...
            child: Row(
              ...
              children: [
                if (item.leadingIconBuilder case final builder?) ...[
                  ...
                  const SizedBox(width: _MateoActionMenuPresentation._iconSpacing),
                ],
                Flexible(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    ...
                    children: [
                      Text(
                        item.title,
                        maxLines: _MateoActionMenuPresentation._textMaxLines,
                        overflow: TextOverflow.ellipsis,
                        style: _MateoActionMenuPresentation._titleStyle.copyWith(color: state.titleColor),
                      ),
                      if (item.description case final description?) ...[
                        const SizedBox(height: _MateoActionMenuPresentation._descriptionSpacing),
                        Text(
                          description,
                          maxLines: _MateoActionMenuPresentation._textMaxLines,
                          overflow: TextOverflow.ellipsis,
                          style: _MateoActionMenuPresentation._descriptionStyle.copyWith(color: state.descriptionColor),
                        ),
                      ],
                    ],
                  ),
