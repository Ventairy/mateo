...
final class _RenderMateoHeaderStandaloneContent extends RenderBox
    with SlottedContainerRenderObjectMixin<_MateoHeaderStandaloneSlot, RenderBox> {
  _RenderMateoHeaderStandaloneContent({
