...
final class _RenderMateoHeaderBoundaryReveal extends RenderProxyBox {
  _RenderMateoHeaderBoundaryReveal({
  ...
  double Function(double maximumExtent) _resolveExtent;
  double? _paintExtent;
  ...
  double Function(double maximumExtent) get resolveExtent => _resolveExtent;
  ...
  set resolveExtent(double Function(double maximumExtent) value) {
  ...
  double _resolvedPaintExtent() {
    return _resolveExtent(_maximumExtent).clamp(0.0, _maximumExtent);
  }
  ...
  void _applyRevealTransform(Matrix4 transform, double extent) {
    transform.scaleByDouble(1, extent / _maximumExtent, 1, 1);
  }
