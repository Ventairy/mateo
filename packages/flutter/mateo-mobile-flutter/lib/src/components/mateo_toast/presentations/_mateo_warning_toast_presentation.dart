...
@immutable
final class _MateoWarningToastPresentation extends MateoToastPresentation {
  const _MateoWarningToastPresentation({this.iconBuilder}) : super._();
  ...
  Widget _buildIcon(Color iconColor) {
    ...
    return MateoIcon.exclamationTriangle(
  ...
  Widget build(BuildContext context) {
    ...
    final colors = context.mateo.colorScheme.toast.warning;
