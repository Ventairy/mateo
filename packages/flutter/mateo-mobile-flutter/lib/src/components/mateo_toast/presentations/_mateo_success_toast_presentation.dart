...
@immutable
final class _MateoSuccessToastPresentation extends MateoToastPresentation {
  const _MateoSuccessToastPresentation({this.iconBuilder}) : super._();
  ...
  Widget build(BuildContext context) {
    ...
    final colors = context.mateo.colorScheme.toast.success;
