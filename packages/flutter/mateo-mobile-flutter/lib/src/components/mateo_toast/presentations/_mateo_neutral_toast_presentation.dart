...
@immutable
final class _MateoNeutralToastPresentation extends MateoToastPresentation {
  const _MateoNeutralToastPresentation({required this.iconBuilder}) : super._();
  ...
  Widget build(BuildContext context) {
    ...
    final colors = context.mateo.colorScheme.toast.neutral;
