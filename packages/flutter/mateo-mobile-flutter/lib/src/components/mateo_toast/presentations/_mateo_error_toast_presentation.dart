...
@immutable
final class _MateoErrorToastPresentation extends MateoToastPresentation {
  const _MateoErrorToastPresentation({this.iconBuilder}) : super._();
  ...
  Widget _buildIcon(Color iconColor) {
    ...
    return MateoIcon.exclamationCircle(
  ...
  Widget build(BuildContext context) {
    ...
    final colors = context.mateo.colorScheme.toast.error;
