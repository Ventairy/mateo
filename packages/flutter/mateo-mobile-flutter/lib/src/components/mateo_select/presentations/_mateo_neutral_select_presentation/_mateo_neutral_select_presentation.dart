...
@immutable
final class _MateoNeutralSelectPresentation extends MateoSelectPresentation {
  const _MateoNeutralSelectPresentation({this.colorScheme}) : super._();
  ...
  MateoSelectVariantColorScheme _resolveColors(MateoSelectColorScheme scheme) => colorScheme ?? scheme.neutral;

  @override
  State<_MateoNeutralSelectPresentation> createState() => _MateoNeutralSelectPresentationState();
}

final class _MateoNeutralSelectPresentationState extends State<_MateoNeutralSelectPresentation>
    with SingleTickerProviderStateMixin {
  final _menuController = MenuController();
  final _triggerFocus = FocusNode(debugLabel: 'MateoSelect neutral source');
  final _menuFocus = FocusNode(debugLabel: 'MateoSelect neutral menu');
  ...
  void initState() {
    ...
    _animation = AnimationController(
      duration: _MateoNeutralSelectPresentation._animationDuration,
      vsync: this,
    );
    _movement = CurvedAnimation(
      parent: _animation,
      curve: _MateoNeutralSelectPresentation._openCurve,
      reverseCurve: _MateoNeutralSelectPresentation._closeCurve,
    );
    _optionsOpacity = CurvedAnimation(
      parent: _animation,
      curve: _MateoNeutralSelectPresentation._optionsOpenCurve,
      reverseCurve: _MateoNeutralSelectPresentation._optionsCloseCurve,
    );
  }
  ...
  bool _measureOrigin() {
    ...
    final padding = _MateoNeutralSelectOptions.optionPadding(index, _menuOptions.length).resolve(
  ...
  Widget _buildMenu(BuildContext context, RawMenuOverlayInfo info) {
    ...
    return _MateoNeutralSelectMenu(
      info: info,
  ...
  Widget build(BuildContext context) {
    ...
    return RawMenuAnchor(
      ...
      child: _MateoNeutralSelectTrigger(
