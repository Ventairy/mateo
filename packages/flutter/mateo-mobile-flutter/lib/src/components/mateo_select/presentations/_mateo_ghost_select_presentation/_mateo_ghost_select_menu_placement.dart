...
final class _MateoGhostSelectMenuPlacement {
  const _MateoGhostSelectMenuPlacement({
    required this.left,
    required this.right,
    required this.top,
  ...
  factory _MateoGhostSelectMenuPlacement.resolve({
    ...
    return _MateoGhostSelectMenuPlacement(
      ...
      maxHeight: math.min<double>(
        usableHeight * _MateoGhostSelectPresentation._menuHeightFraction,
        availableHeight,
      ),
    );
  }
