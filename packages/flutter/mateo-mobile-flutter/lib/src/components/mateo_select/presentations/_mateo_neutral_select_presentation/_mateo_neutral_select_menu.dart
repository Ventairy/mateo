...
final class _MateoNeutralSelectMenu extends StatelessWidget {
  const _MateoNeutralSelectMenu({
    required this.info,
  ...
  Widget build(BuildContext context) {
    final geometry = _MateoNeutralSelectMenuPlacement.resolve(
      overlaySize: info.overlaySize,
      sourceRect: info.anchorRect,
      mediaQuery: mediaQuery,
      horizontalSafeAreaGutter: _MateoNeutralSelectPresentation._horizontalSafeAreaGutter,
    );
    return Focus(
      focusNode: focusNode,
