...
final Finder surfaceFlight = find.byWidgetPredicate(
  ...
  description: 'the filled surface flight',
);
...
Widget surfaceTransformEndpoint({
  ...
  final animation = disabled ? const MateoSurfaceAnimation.none() : MateoSurfaceAnimation.transform(id: id);
...
Future<void> startSurfaceFlight(WidgetTester tester, NavigatorState navigator, Widget destination) async {
...
ShapeDecoration surfaceFlightDecoration(WidgetTester tester) =>
